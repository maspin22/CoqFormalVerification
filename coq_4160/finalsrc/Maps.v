...
Proof.
  (* SOLUTION: *)
  intros. unfold t_update. rewrite <- beq_nat_refl.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  unfold t_update. destruct (x1 =? x2).
  - reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  (* SOLUTION: *)
  intros x y.
  apply iff_reflect. rewrite Nat.eqb_eq.
  reflexivity.
Qed.
(** [] *)
