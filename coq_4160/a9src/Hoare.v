...
(** The problem is the [apply Hhoare with...] part of the proof.  Coq
    ...
    that will use _existential_ variables to make progress even when
    ...
    [Heval].  When we use [eapply] we are essentially telling Coq, "Be
...
(** Of course, it's hard to predict [eauto] would have sufficed
    here without having gone through the original proof of
