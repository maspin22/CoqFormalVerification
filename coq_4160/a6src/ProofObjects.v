...
Definition or_elim : forall (P Q R : Prop), (P \/ Q) -> (P -> R) -> (Q -> R) -> R :=
  fun P Q R HPQ HPR HQR =>
    match HPQ with
    | or_introl _ _ HP => HPR HP
    | or_intror _ _ HQ => HQR HQ
    end.
...
Definition or_commut' : forall P Q, P \/ Q -> Q \/ P
  := fun P Q H  =>
    match H with
    | or_introl _ HP => or_intror _ HP
    | or_intror _ HQ => or_introl _ HQ
    end.
(** [] *)
...
Proof.
 intros X x y H P. inversion H. intros H'. apply H'.
Qed.
(** [] *)
