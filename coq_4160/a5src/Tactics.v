...
Proof.
  ...
  apply eq_sym. apply rev_involutive.  Qed.
(** [] *)
...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros X x y z l j H1 H2. injection H1. rewrite -> H2. 
  intros H3 H4. injection H3. rewrite <- H4. apply eq_sym.
  Qed.
...
Proof.
  ...
  -destruct m.
   ...
   +intros H. f_equal. apply IHn. 
    ...
    injection H'. intro sol. apply sol. 
Qed.
...
Proof.
  ...
  -simpl. destruct n.
   +simpl. discriminate. 
   +simpl. intro H. injection H. apply IHl. 
Qed.
(** [] *)
...
Proof.
  ...
  -simpl. 
   unfold combine. intro l1. destruct l1.
   +reflexivity.  
   +discriminate.
  -destruct h as [h1 h2]. simpl. destruct (split t). 
   intros l1 l2 H. injection H as H' H''.
    rewrite <- H'. rewrite <-  H''. simpl.
    rewrite IHt. reflexivity. reflexivity.
Qed.
(** [] *)
