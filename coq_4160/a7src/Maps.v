...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
    ...
    (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros. apply functional_extensionality. intro. unfold t_update.
  destruct (eqb_stringP x1 x). destruct (eqb_stringP x2 x).
  rewrite <- e0 in e. rewrite e in H. destruct H. reflexivity. reflexivity.
  reflexivity.
Qed.
(** [] *)
